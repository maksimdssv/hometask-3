export default function isNote(obj: object, keysObj: object) {
    if (typeof obj !== "object") throw new Error("Sent data is not an object");
    if (Object.keys(obj).length !== Object.keys(keysObj).length) throw new Error(`Wrong fields provided, fields must be: ${Object.keys(keysObj).join(", ")}`);
